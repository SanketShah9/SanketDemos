...
@property(nonatomic)BOOL isHeader;// Additional offset of header

@property(nonatomic)BOOL isUseOwnViewWillAppear;// Additional management of viewdisappear

@property (nonatomic) CGFloat additionalOffsetYForHeader;
...
@property (nonatomic) BOOL areUIBarsAnimating, areUIBarBackgroundsReady;;
...
- (void)barShown:(YIFullScreenScroll*)fullScreenScroll;
@end
